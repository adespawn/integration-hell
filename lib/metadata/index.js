...
const { SessionWrapper } = require("../../index");
...
class Metadata {
    ...
    constructor(client) {
        /** @type {SessionWrapper} */
        this.rustClient = client.rustClient;
        this._client = client;
    }
     ...
     */
    getSingleKeyspace(name) {
        return this.rustClient.getFilteredKeyspaceMetadata(name);
    }
     ...
     */
    getKeyspaces() {
        return this.rustClient.getAllKeyspacesMetadata();
    }
