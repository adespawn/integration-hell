...
impl QueryExecutor {
    ...
    ) -> JsResult<JsPromise<PagingResult>> {
...
impl SessionWrapper {
    ...
    ) -> JsResult<JsPromise<SessionWrapper>> {
        with_custom_error_sync(|| {
            submit_future(&env, async move {
    ...
    ) -> JsResult<JsPromise<QueryResultWrapper>> {
        with_custom_error_sync(|| {
    ...
    pub fn prepare_statement(
        ...
        env: Env,
        statement: String,
    ) -> JsResult<JsPromise<Vec<ComplexType<'static>>>> {
        with_custom_error_sync(|| {
            let inner = Arc::clone(&self.inner);
            submit_future(&env, async move {
    ...
    pub fn query_single_page_encoded(
        ...
        options: &QueryOptionsWrapper,
        paging_state: Option<&PagingStateWrapper>,
    ) -> JsResult<JsPromise<PagingResultWithExecutor>> {
        with_custom_error_sync(|| {
